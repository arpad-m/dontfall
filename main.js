...
var _arpad_m$dontfall$Background$backgroundColor = A3(_elm_lang$core$Color$rgb, 30, 19, 67);
var _arpad_m$dontfall$Background$xgen = function (x) {
	return A2(_elm_lang$core$Random$float, (0 - x) / 2, x / 2);
};
var _arpad_m$dontfall$Background$bgCircle = F3(
	function (x, y, s) {
		return A2(
			...
			A2(
				...
				_evancz$elm_graphics$Collage$circle(s)));
	});
var _arpad_m$dontfall$Background$generateBgCircle = F2(
	function (width, height) {
		return A4(
			_elm_lang$core$Random$map3,
			_arpad_m$dontfall$Background$bgCircle,
			_arpad_m$dontfall$Background$xgen(width),
			_arpad_m$dontfall$Background$xgen(height),
			A2(_elm_lang$core$Random$float, 1, 3));
	});
var _arpad_m$dontfall$Background$background = F2(
	function (width, height) {
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_arpad_m$dontfall$Background$backgroundColor,
				...
				function () {
					var _p0 = A2(
						...
						A2(
							...
							_elm_lang$core$Basics$round((width * height) / 9000),
							A2(_arpad_m$dontfall$Background$generateBgCircle, width, height)),
						_elm_lang$core$Random$initialSeed(2356));
					var l = _p0._0;
					return l;
				}()));
	});

var _arpad_m$dontfall$Platforms$platformDistance = 30;
var _arpad_m$dontfall$Platforms$pldf = function (f) {
	return _elm_lang$core$Basics$floor(f / _arpad_m$dontfall$Platforms$platformDistance);
};
var _arpad_m$dontfall$Platforms$ipldf = function (f) {
	return _elm_lang$core$Basics$toFloat(f) * _arpad_m$dontfall$Platforms$platformDistance;
};
var _arpad_m$dontfall$Platforms$maybeRandom = F2(
	function (bgen, gen) {
		return A3(
			_elm_lang$core$Random$map2,
			F2(
				function (b, c) {
					return b ? _elm_lang$core$Maybe$Just(c) : _elm_lang$core$Maybe$Nothing;
				}),
			bgen,
			gen);
	});
var _arpad_m$dontfall$Platforms$oneIn = function (i) {
	return A2(
		_elm_lang$core$Random$map,
		F2(
			function (x, y) {
		...
		A2(_elm_lang$core$Random$int, 0, i));
};
var _arpad_m$dontfall$Platforms$genPlatforms = F3(
	function (flWidth, yOffs, pixeldiff) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: _arpad_m$dontfall$Platforms$pldf(yOffs),
			_1: _arpad_m$dontfall$Platforms$pldf(yOffs + pixeldiff)
		};
		var oldYInt = _p0._0;
		var newYInt = _p0._1;
		return A2(
					...
					return A2(
						...
						function (x) {
							return {
								ctor: '_Tuple2',
								_0: x,
								_1: _arpad_m$dontfall$Platforms$ipldf(_p2._0)
							};
						},
						_p2._1);
				}),
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.range(oldYInt, newYInt - 1)),
				A2(
					_elm_lang$core$Random$list,
					newYInt - oldYInt,
					A2(
						_arpad_m$dontfall$Platforms$maybeRandom,
						_arpad_m$dontfall$Platforms$oneIn(2),
						A2(_elm_lang$core$Random$float, 0, flWidth)))));
	});

var _arpad_m$dontfall$BaseStuff$InitFlags = F3(
	function (a, b, c) {
		return {width: a, height: b, seed: c};
	});
var _arpad_m$dontfall$BaseStuff$GameData = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _arpad_m$dontfall$BaseStuff$GameOver = {ctor: 'GameOver'};
var _arpad_m$dontfall$BaseStuff$Paused = {ctor: 'Paused'};
var _arpad_m$dontfall$BaseStuff$initGameData$ = F3(
	function (width, height, seed) {
		var _p0 = A2(
			_elm_lang$core$Random$step,
			A3(
				_arpad_m$dontfall$Platforms$genPlatforms,
				_elm_lang$core$Basics$toFloat(width),
				0,
				_elm_lang$core$Basics$toFloat(2 * height)),
			seed);
		var platforms = _p0._0;
		var nextSeed = _p0._1;
		return {
			width: width,
			height: height,
			flWidth: _elm_lang$core$Basics$toFloat(width),
			...
			seed: nextSeed,
			background: A2(
				_arpad_m$dontfall$Background$background,
				_elm_lang$core$Basics$toFloat(width),
				_elm_lang$core$Basics$toFloat(height))
		};
	});
var _arpad_m$dontfall$BaseStuff$initGameData = function (_p1) {
	var _p2 = _p1;
	return {
		ctor: '_Tuple2',
		_0: A3(
			_arpad_m$dontfall$BaseStuff$initGameData$,
			_p2.width,
			_p2.height,
			_elm_lang$core$Random$initialSeed(_p2.seed)),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _arpad_m$dontfall$BaseStuff$resetGameData = function (_p3) {
	var _p4 = _p3;
	return A3(_arpad_m$dontfall$BaseStuff$initGameData$, _p4.width, _p4.height, _p4.seed);
};
var _arpad_m$dontfall$BaseStuff$Running = {ctor: 'Running'};
var _arpad_m$dontfall$BaseStuff$JumpUp = {ctor: 'JumpUp'};
var _arpad_m$dontfall$BaseStuff$JumpDown = {ctor: 'JumpDown'};
var _arpad_m$dontfall$BaseStuff$PauseToogle = {ctor: 'PauseToogle'};
var _arpad_m$dontfall$BaseStuff$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _arpad_m$dontfall$BaseStuff$MouseMove = function (a) {
	return {ctor: 'MouseMove', _0: a};
};
var _arpad_m$dontfall$BaseStuff$NothingHappened = {ctor: 'NothingHappened'};
...
var _arpad_m$dontfall$Render$newGameStartText = A2(
	_evancz$elm_graphics$Text$color,
	_elm_lang$core$Color$white,
	_evancz$elm_graphics$Text$fromString('Press [P] to start new game.'));
var _arpad_m$dontfall$Render$gameOverString = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$String$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				'Game over. Reached height: ',
				_elm_lang$core$Basics$toString(
				_elm_lang$core$Basics$round(_p1.gameWinY))
			]));
};
var _arpad_m$dontfall$Render$gameOverText = function (d) {
	return A2(
		_evancz$elm_graphics$Text$color,
		_elm_lang$core$Color$white,
		_evancz$elm_graphics$Text$fromString(
			_arpad_m$dontfall$Render$gameOverString(d)));
};
var _arpad_m$dontfall$Render$pausedText = A2(
	_evancz$elm_graphics$Text$color,
	_elm_lang$core$Color$white,
	_evancz$elm_graphics$Text$fromString('Game paused. Press [P] to resume.'));
var _arpad_m$dontfall$Render$playerHeight = 50;
var _arpad_m$dontfall$Render$playerWidth = 40;
var _arpad_m$dontfall$Render$playerColor = A3(_elm_lang$core$Color$rgb, 0, 128, 0);
var _arpad_m$dontfall$Render$playerModel = A2(
	_evancz$elm_graphics$Collage$filled,
	_arpad_m$dontfall$Render$playerColor,
	A2(_evancz$elm_graphics$Collage$rect, _arpad_m$dontfall$Render$playerWidth, _arpad_m$dontfall$Render$playerHeight));
var _arpad_m$dontfall$Render$platformWidth = 76;
var _arpad_m$dontfall$Render$platformColor = A3(_elm_lang$core$Color$rgb, 100, 19, 67);
var _arpad_m$dontfall$Render$plFill = _evancz$elm_graphics$Collage$filled(_arpad_m$dontfall$Render$platformColor);
var _arpad_m$dontfall$Render$platformModel = _evancz$elm_graphics$Collage$group(
	_elm_lang$core$Native_List.fromArray(
		[
			_arpad_m$dontfall$Render$plFill(
			A2(_evancz$elm_graphics$Collage$rect, 60, 16)),
			A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: -30, _1: 0},
			_arpad_m$dontfall$Render$plFill(
...
var _arpad_m$dontfall$Render$renderPlatform = F2(
	function (_p3, _p2) {
		var _p4 = _p3;
		var _p5 = _p2;
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: _p5._0 - (_p4.flWidth / 2), _1: (_p5._1 - (_p4.flHeight / 2)) - _p4.gameWinY},
			_arpad_m$dontfall$Render$platformModel);
	});
var _arpad_m$dontfall$Render$renderScene = function (d) {
	return A3(
		...
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_arpad_m$dontfall$Render$renderPlatform(d),
					d.platforms),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_evancz$elm_graphics$Collage$move,
							{ctor: '_Tuple2', _0: d.characterPosX - (d.flWidth / 2), _1: (d.characterPosY - (d.flHeight / 2)) - d.gameWinY},
							_arpad_m$dontfall$Render$playerModel)
						]),
					_elm_lang$core$Native_Utils.eq(d.state, _arpad_m$dontfall$BaseStuff$Paused) ? _elm_lang$core$Native_List.fromArray(
						[
							_evancz$elm_graphics$Collage$text(_arpad_m$dontfall$Render$pausedText)
						]) : A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[]),
						_elm_lang$core$Native_Utils.eq(d.state, _arpad_m$dontfall$BaseStuff$GameOver) ? _elm_lang$core$Native_List.fromArray(
							[
								_evancz$elm_graphics$Collage$text(
								_arpad_m$dontfall$Render$gameOverText(d)),
								A2(
								_evancz$elm_graphics$Collage$move,
								{ctor: '_Tuple2', _0: 0, _1: -17},
								_evancz$elm_graphics$Collage$text(_arpad_m$dontfall$Render$newGameStartText))
							]) : _elm_lang$core$Native_List.fromArray(
							[]))))));
};
...
var _arpad_m$dontfall$Main$onMouseMove = A2(
	...
	A3(
		...
		F2(
			function (x, y) {
				return _arpad_m$dontfall$BaseStuff$MouseMove(
					{ctor: '_Tuple2', _0: x, _1: y});
			}),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'offsetX', _elm_lang$core$Json_Decode$float),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'offsetY', _elm_lang$core$Json_Decode$float)));
var _arpad_m$dontfall$Main$render = function (d) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_arpad_m$dontfall$Main$onMouseMove]),
		_elm_lang$core$Native_List.fromArray(
			[
				_evancz$elm_graphics$Element$toHtml(
				_arpad_m$dontfall$Render$renderScene(d))
			]));
};
var _arpad_m$dontfall$Main$jumpTippingPoint = 460;
var _arpad_m$dontfall$Main$jumpTippingPointTime = _arpad_m$dontfall$Main$jumpTippingPoint * _elm_lang$core$Time$millisecond;
var _arpad_m$dontfall$Main$calcJumpCurve = function (t) {
...
var _arpad_m$dontfall$Main$intsOverlap = F4(
	function (i, j, k, l) {
		return _elm_lang$core$Native_Utils.cmp(
			A2(_elm_lang$core$Basics$max, i, k),
			A2(_elm_lang$core$Basics$min, j, l)) < 1;
	});
var _arpad_m$dontfall$Main$playerXcollidesWithPlatform = F2(
	function (characterPosX, _p0) {
		var _p1 = _p0;
		var _p2 = _p1._0;
		return A4(_arpad_m$dontfall$Main$intsOverlap, _p2 - (_arpad_m$dontfall$Render$platformWidth / 2), _p2 + (_arpad_m$dontfall$Render$platformWidth / 2), characterPosX - (_arpad_m$dontfall$Render$playerWidth / 2), characterPosX + (_arpad_m$dontfall$Render$playerWidth / 2));
	});
var _arpad_m$dontfall$Main$playerCollidesPlatformInFall = F4(
	function (characterPosX, characterPosYmin, characterPosYmax, _p3) {
		var _p4 = _p3;
		var _p5 = _p4._1;
		return A2(
			_arpad_m$dontfall$Main$playerXcollidesWithPlatform,
			characterPosX,
			{ctor: '_Tuple2', _0: _p4._0, _1: _p5}) && ((_elm_lang$core$Native_Utils.cmp(characterPosYmin - (_arpad_m$dontfall$Render$playerHeight / 2), _p5) < 1) && (_elm_lang$core$Native_Utils.cmp(characterPosYmax - (_arpad_m$dontfall$Render$playerHeight / 2), _p5) > -1));
	});
var _arpad_m$dontfall$Main$playerCollidesDuringFall = F2(
	function (newCharacterPosY, _p6) {
		var _p7 = _p6;
		var _p11 = _p7.characterPosY;
		var _p8 = {
			ctor: '_Tuple2',
			_0: A2(_elm_lang$core$Basics$min, _p11, newCharacterPosY),
			_1: A2(_elm_lang$core$Basics$max, _p11, newCharacterPosY)
		};
		var minPosY = _p8._0;
		var maxPosY = _p8._1;
		return A2(
			_elm_lang$core$Maybe$map,
			function (p) {
				return p + (_arpad_m$dontfall$Render$playerHeight / 2);
			},
			((_elm_lang$core$Native_Utils.cmp(newCharacterPosY, _p11) < 0) ? _elm_lang$core$List$maximum : _elm_lang$core$List$minimum)(
				A2(
					_elm_lang$core$List$map,
					function (_p9) {
						var _p10 = _p9;
					...
					A2(
						...
						function (pl) {
							return A4(_arpad_m$dontfall$Main$playerCollidesPlatformInFall, _p7.characterPosX, minPosY, maxPosY, pl);
						},
						_p7.platforms))));
	});
			...
			if (_p13.ctor === 'Nothing') {
				...
				return function (nd) {
					return function (nd) {
						...
						_elm_lang$core$Native_Utils.update(
							nd,
							{characterPosY: _p13._0}));
				}(d);
			}
		}
	});
var _arpad_m$dontfall$Main$removeOldPlatforms = function (d) {
	return _elm_lang$core$Native_Utils.update(
		d,
		{
			platforms: A2(
				...
				function (_p15) {
					var _p16 = _p15;
					return _elm_lang$core$Native_Utils.cmp(_p16._1 - d.gameWinY, -30) > -1;
				},
				d.platforms)
		});
};
var _arpad_m$dontfall$Main$getClosestAbove = F2(
	function (l, py) {
		return _elm_lang$core$List$minimum(
			A2(
				...
				function (_p17) {
					var _p18 = _p17;
					var _p19 = _p18._1;
					return (_elm_lang$core$Native_Utils.cmp(_p19, py) > 0) ? _elm_lang$core$Maybe$Just(_p19) : _elm_lang$core$Maybe$Nothing;
				},
				l));
	});
...
var _arpad_m$dontfall$Main$speed = function (_p27) {
	...
	return (A2(
		_elm_lang$core$Basics$min,
		3,
		A2(_elm_lang$core$Basics$max, 1, _p28.gameWinY / 5000)) * 100) / 1000;
};
var _arpad_m$dontfall$Main$stepTime = F2(
	function (d, t) {
		var pixeldiff = A2(
			_elm_lang$core$Basics$max,
...
var _arpad_m$dontfall$Main$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{init: _arpad_m$dontfall$BaseStuff$initGameData, view: _arpad_m$dontfall$Main$render, update: _arpad_m$dontfall$Main$updateScene, subscriptions: _arpad_m$dontfall$Main$subscriptions}),
	flags: A2(
		...
		function (height) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'seed', _elm_lang$core$Json_Decode$int),
				function (seed) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _arpad_m$dontfall$Main$main === 'undefined' ? null : _arpad_m$dontfall$Main$main);
